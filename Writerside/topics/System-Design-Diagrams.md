...
| **Exceptions**           | **System Error**: If there is a system error during the registration process, an error message is displayed to the user.</br>2. The user may try to register again later.                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| **Normal Flow**          | **Create Thread:**</br>1. User navigates to the forum page and selects the option to create a new thread.</br>2. System presents a form for entering the thread title and description.</br>3. User enters the thread details and submits the form.</br>4. User Interface captures the thread details and sends them to ForumService.</br>5. ForumService validates the input and sends the thread data to DatabaseService.</br>6. DatabaseService saves the new thread and confirms the successful creation back to ForumService.</br>7. ForumService confirms the successful creation to the User Interface.</br>8. User Interface displays the new thread in the forum.</br></br>**Delete Thread:**</br>1. User selects an existing thread they created and chooses the option to delete it.</br>2. System prompts the user to confirm the deletion.</br>3. User confirms the deletion.</br>4. User Interface sends the delete request to ForumService.</br>5. ForumService validates the request and sends the thread ID to DatabaseService.</br>6. DatabaseService deletes the thread and associated posts, confirming the deletion back to ForumService.</br>7. ForumService confirms the successful deletion to the User Interface.</br>8. User Interface removes the deleted thread from the forum display. |
| **Alternative Flow**     | **Thread Creation Error**:</br>1. If there is an error creating the thread, ForumService returns an error message.</br>2. User Interface displays the error message to the user.</br>3. User can correct the input and resubmit the form.</br>4. The system processes the new thread details as described in the Normal Flow.</br></br>**Thread Deletion Error**:</br>1. If there is an error deleting the thread, ForumService returns an error message.</br>2. User Interface displays the error message to the user.</br>3. User can retry the deletion.</br>4. The system processes the deletion request as described in the Normal Flow.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| **Exceptions**           | **System Error**:</br>1. If there is a system error during the thread creation or deletion process, an error message is displayed to the user.</br>2. The user may try to create or delete a thread again later.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| **Normal Flow**          | **Create Post:**</br>1. User navigates to a specific thread and selects the option to create a new post.</br>2. System presents a form for entering the post content.</br>3. User enters the post details and submits the form.</br>4. User Interface captures the post details and sends them to ForumService.</br>5. ForumService validates the input and sends the post data to DatabaseService.</br>6. DatabaseService saves the new post and confirms the successful creation back to ForumService.</br>7. ForumService confirms the successful creation to the User Interface.</br>8. User Interface displays the new post in the thread.</br></br>**Edit Post:**</br>1. User selects their own post and chooses the option to edit it.</br>2. System presents a form pre-filled with the existing post content.</br>3. User modifies the content and submits the form.</br>4. User Interface sends the updated content to ForumService.</br>5. ForumService validates the updated details and sends an update request to DatabaseService.</br>6. DatabaseService updates the post and confirms the update back to ForumService.</br>7. ForumService confirms the successful update to the User Interface.</br>8. User Interface displays the updated post content.</br></br>**Reply to Post:**</br>1. User selects the reply option on a post.</br>2. System presents a form for entering the reply content.</br>3. User writes their reply and submits it.</br>4. User Interface captures the reply and forwards it to ForumService.</br>5. ForumService processes the reply, attaching it to the original post, and sends it to DatabaseService.</br>6. DatabaseService stores the reply and links it under the original post, confirming back to ForumService.</br>7. ForumService confirms the successful addition of the reply to the User Interface.</br>8. User Interface displays the new reply under the original post.</br></br>**Delete Post:**</br>1. User selects the delete option on their post.</br>2. System asks the user to confirm the deletion to prevent accidental removals.</br>3. User confirms the deletion.</br>4. User Interface sends the delete request to ForumService.</br>5. ForumService verifies the user's authority to delete the post and sends a delete command to DatabaseService.</br>6. DatabaseService deletes the post and returns a confirmation of deletion to ForumService.</br>7. ForumService confirms the deletion to the User Interface.</br>8. User Interface updates to reflect the deletion of the post. |
| **Alternative Flow**     | **Post Creation Error**:</br>1. If there is an error creating the post, ForumService returns an error message.</br>2. User Interface displays the error message to the user.</br>3. User can correct the input and resubmit the form.</br>4. The system processes the new post details as described in the Normal Flow.</br></br>**Post Edit Error**:</br>1. If there is an error editing the post, ForumService returns an error message.</br>2. User Interface displays the error message to the user.</br>3. User can correct the input and resubmit the form.</br>4. The system processes the updated post details as described in the Normal Flow.</br></br>**Reply Creation Error**:</br>1. If there is an error creating the reply, ForumService returns an error message.</br>2. User Interface displays the error message to the user.</br>3. User can correct the input and resubmit the form.</br>4. The system processes the new reply details as described in the Normal Flow.</br></br>**Post Deletion Error**:</br>1. If there is an error deleting the post, ForumService returns an error message.</br>2. User Interface displays the error message to the user.</br>3. User can retry the deletion.</br>4. The system processes the deletion request as described in the Normal Flow.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| **Exceptions**           | **System Error**:</br>1. If there is a system error during the post creation, editing, reply, or deletion process, an error message is displayed to the user.</br>2. The user may try to create, edit, reply to, or delete a post again later.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
